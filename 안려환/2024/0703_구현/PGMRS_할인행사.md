...
전체 돌면 터지니, 10일치 먼저 받아두고 맨 첫날 제거하고 맨 뒷 날 더해가면서 값을 비교하였다.


# 해멘 이유
문제를 잘 안읽었다.... 이게 가입 가능한 날짜 하나 뱉어야 하는줄알았는데 그게 아니라 가능한 날짜의 합게를 뱉는 것이었다. 로직이 맞는 것같은데 틀릴 때는 문제를 다시 읽어보자.
