...
# 전략
문제에서 나오듯 stack 을 활용하는 부분과 매 상자들에서 택배가 나올 때 매번 스택에서 확인해서 꺼낼 수 있는 상자면 올바른 상자가 나오는한 계속 꺼내도록 지정하여 풀이했다.
